...
export const flowData = {
  ...
  "installation-flow": [
    ...
    },
    {
      ...
      note: "",
      position: { top: "77.5%", left: "45%", width: "30%" },
      arrow: "top",
      points: [
    ...
    },
    {
      ...
      title: "Select the TDL",
      note: "",
      position: { top: "21%", left: "73%", width: "30%" },
      arrow: "right",
    ...
    },
    {
      ...
      note: "",
      position: { top: "35.5%", left: "54%", width: "34%" },
      arrow: "left",
      points: [
  ...
  "account-linking-flow": [
    {
      ...
      position: { top: "14%", left: "76%", width: "25%" },
      arrow: "right",
      points: [],
    },
    {
    ...
    },
    {
      ...
      title: "",
      note: "",
      position: { top: "24%", left: "20%", width: "37%" },
      arrow: "top",
      points: [
  ...
  "token-generation": [
    ...
    },
    {
      ...
      position: { top: "27%", left: "28%", width: "30%" },
      arrow: "top",
      points: [],
    },
    {
    ...
    },
    {
      ...
      position: { top: "70%", left: "31%", width: "28%" },
      arrow: "left",
      points: [],
    },
    {
      ...
      position: { top: "16%", left: "48.5%", width: "26%" },
      arrow: "left",
      points: [],
    },
    {
    ...
    },
    {
      ...
      position: { top: "27%", left: "82%", width: "24%" },
      arrow: "top",
      points: [],
    },
  ],
  "corpid-userid-flow": [
    {
      ...
      arrow: "right",
      points: ["Select Bank Plugin from the Payment Gateway"],
    },
    {
      image: corpStep2,
      title: "",
      note: "",
      position: { top: "73%", left: "50%", width: "26%" },
      arrow: "top",
      points: [
        "Login with Mobile number and Password mentioned during Product Registration",
      ],
    },
    {
      image: corpStep3,
      ...
      arrow: "right",
      points: ["Select the Yes button using Spacebar"],
    },
    {
      image: corpStep4,
      title: "",
      ...
      arrow: "left",
      points: [
        "Enter CIB login ID of ICICI Bank Current Account and click on Regsiter",
      ],
    },
    {
      image: corpStep5,
      ...
      arrow: "left",
      points: [
        " Click on “Approve” to approve the registration request on CIB Platform",
      ],
    },
    {
      image: corpStep6,
      ...
      arrow: "top",
      points: ["Login to ICICI Bank CIB Platform"],
    },
    {
      image: corpStep7,
      title: "",
      ...
      arrow: "left",
      points: ["Connected Banking Opens"],
    },
    {
      image: corpStep8,
      title: "",
      ...
      arrow: "left",
      points: [
        "Select the Connected Banking option present on the Left-Hand side bar",
      ],
    },
    {
      image: corpStep9,
      title: "",
      note: "",
      position: { top: "10%", left: "50%", width: "25%" },
      arrow: "left",
      points: ["Select the Connected Banking Approvals"],
    },
    {
      image: corpStep10,
      title: "",
      ...
      arrow: "top",
      points: [
        "All the pending Connected Banking request for “Tally ERP Plugin” is shown",
      ],
    },
    {
      image: corpStep11,
    ...
    },
    {
      ...
      arrow: "left",
      points: ["Enter the One Time Password and Confirm"],
    },
    {
      image: corpStep13,
      title: "",
      ...
      arrow: "right",
      points: ["The status changes to registered"],
    },
    {
      image: corpStep14,
      title: "",
    ...
    },
    {
      ...
      title: "",
      note: "",
      position: { top: "74%", left: "75%", width: "28%" },
      arrow: "right",
      points: ["Click on Check Status"],
    },
    {
      image: corpStep15,
      title: "",
      ...
      arrow: "left",
      points: ["Approved status will be displayed and click on “OK”"],
    },
    {
      image: corpStep16,
      title: "",
      note: "",
      position: { top: "48%", left: "75%", width: "34%" },
      arrow: "left",
      points: ["Congratulations Tally Bank Plugin is ready to use"],
    },
  ],
};
